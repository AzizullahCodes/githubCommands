...
<h3>Adding a new repository all process</h3>
...
❌ Running git remote add origin twice → if it says "remote origin already exists", either skip it or  <br/>
run git remote remove origin first <br/>
